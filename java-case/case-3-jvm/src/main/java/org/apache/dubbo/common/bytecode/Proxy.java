...
public abstract class Proxy {
  ...
  public static final InvocationHandler EMPTY_HANDLER = (proxy, method, args) -> null;
  ...
  public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
    ...
    synchronized (PROXY_CACHE_MAP) {
      cache = PROXY_CACHE_MAP.computeIfAbsent(ics[0].getClassLoader(), k -> new HashMap<>());
    }
  ...
  public Object newInstance() {
    return newInstance(EMPTY_HANDLER);
  }
